    ...
    !function(t, e) {
      ...
      return function(t2) {
        ...
        return n.m = t2, n.c = e, n.d = function(t3, e2, o) {
          ...
          if (n.r(o), Object.defineProperty(o, "default", { enumerable: true, value: t3 }), 2 & e2 && "string" != typeof t3) for (var i in t3) n.d(o, i, (function(e3) {
            return t3[e3];
          }).bind(null, i));
          return o;
        }, n.n = function(t3) {
        ...
        }, u = n(1), a = "object" == typeof self && self && self.Object === Object && self, c = u.a || a || Function("return this")(), s = function() {
          return c.Date.now();
        ...
        var g = function(t3) {
          return null == t3 ? void 0 === t3 ? "[object Undefined]" : "[object Null]" : b && b in Object(t3) ? m(t3) : y(t3);
        };
        var j = function(t3) {
          return null != t3 && "object" == typeof t3;
        };
        var $ = function(t3) {
          return "symbol" == typeof t3 || j(t3) && "[object Symbol]" == g(t3);
        ...
        var D = function(t3, e2, n2) {
          ...
          function y2(t4) {
            var n3 = t4 - l2;
            return void 0 === l2 || n3 >= e2 || n3 < 0 || p2 && t4 - f2 >= u2;
          }
          function b2() {
            var t4 = s();
            if (y2(t4)) return g2(t4);
          ...
          function j2() {
            ...
            if (o2 = arguments, i2 = this, l2 = t4, n3) {
              if (void 0 === c2) return h2(l2);
              if (p2) return clearTimeout(c2), c2 = setTimeout(b2, e2), m2(l2);
            }
            return void 0 === c2 && (c2 = setTimeout(b2, e2)), a2;
          }
          return e2 = E(e2) || 0, r(n2) && (d2 = !!n2.leading, u2 = (p2 = "maxWait" in n2) ? T(E(n2.maxWait) || 0, e2) : u2, v2 = "trailing" in n2 ? !!n2.trailing : v2), j2.cancel = function() {
            void 0 !== c2 && clearTimeout(c2), f2 = 0, o2 = l2 = i2 = c2 = void 0;
          }, j2.flush = function() {
            return void 0 === c2 ? a2 : g2(s());
          }, j2;
        };
        ...
        if (M < 3) throw new Error("The CKEditor plugin works only with Vue 3+. For more information, please refer to https://ckeditor.com/docs/ckeditor5/latest/builds/guides/integration/frameworks/vuejs-v3.html");
        const P = { install(t3) {
